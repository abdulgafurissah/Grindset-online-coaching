    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200 h-16 flex items-center px-6">
                <Link href="/" className="font-bold text-xl text-black-rich tracking-widest">GRINDHUB</Link>
            </nav>
            ...
            <main className="pt-24 pb-12 px-4 md:px-8">
                <div className="max-w-3xl mx-auto text-center mb-8">
                    ...
                    <p className="text-slate-600 text-lg">Join the elite team of GrindHub coaches. Submit your application below.</p>
                </div>
